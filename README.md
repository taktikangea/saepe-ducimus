...
![CI](https://github.com/taktikangea/saepe-ducimus/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@taktikangea/saepe-ducimus.svg?style=flat)](https://www.npmjs.com/package/@taktikangea/saepe-ducimus)
...
const inject = require('@taktikangea/saepe-ducimus')
...
```typescript
import * as LightMyRequest from '@taktikangea/saepe-ducimus'
...
// or
import { inject, DispatchFunc } from '@taktikangea/saepe-ducimus'
...
- `inject` - standard @taktikangea/saepe-ducimus `inject` method
- `DispatchFunc` - the fake HTTP dispatch function
- `InjectPayload` - a union type for valid payload types
- `isInjection` - standard @taktikangea/saepe-ducimus `isInjection` method
- `InjectOptions` - options object for `inject` method
- `Request` - custom @taktikangea/saepe-ducimus `request` object interface. Extends
...
- `Response` - custom @taktikangea/saepe-ducimus `response` object interface. Extends Node.js `http.ServerResponse` type
...
- Beware when using the `Request` option. That might make _@taktikangea/saepe-ducimus_
...
Checks if given object `obj` is a *@taktikangea/saepe-ducimus* `Request` object.
...
All the credits before the commit [00a2a82](https://github.com/taktikangea/saepe-ducimus/commit/00a2a82eb773b765003b6085788cc3564cd08326) goes to the `hapi/shot` project [contributors](https://github.com/hapijs/shot/graphs/contributors).
Since the commit [db8bced](https://github.com/taktikangea/saepe-ducimus/commit/db8bced10b4367731688c8738621d42f39680efc) the project will be maintained by the Fastify team.
